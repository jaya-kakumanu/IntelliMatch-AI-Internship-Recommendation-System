...
def recommend_internships(candidate_profile, top_n=5):
    """
    Recommend top N internships based on candidate profile.
    candidate_profile: str (skills, interests, role, education)
...
candidate_profile = input("\n🧍 Enter your profile details (e.g., skills, education, role):\n➡️ ")
